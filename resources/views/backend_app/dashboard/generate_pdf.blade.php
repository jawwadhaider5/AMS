...
<body>
  ...
  $expire_date = new DateTime($task->expire_date);
  ...
  <header class="clearfix">
    <div class="header-top">
      ...
      <img src="{{ asset('assets/logo/1.jpeg') }}" alt="" />
        <h1>{{$system->system_name}} - {{$system->systemtype->name}} - Wordload</h1>
      </div>
    </div>
  </header>
  <main>
            ...
            <table class="table-bordered">
              <tbody>
                ...
                <tr>
                  ...
                  <td colspan="2">{{$asset->location}}</td>
                </tr>
                <tr>
                  <td colspan="2">Manufacturer</td>
                  <td colspan="2">{{$asset->manufacturer}}</td>
                </tr>
                <tr>
                  <td colspan="2">Model</td>
                  <td colspan="2">{{$asset->system_modal}}</td>
                </tr>
                <tr>
                  <td colspan="2">Serial No.</td>
                  <td colspan="2">{{$asset->serial_no}}</td>
                </tr>
            ...
            <table class="table-bordered">
              <tbody>
                ...
                <tr>
                  ...
                  <td colspan="2">{{ $month_difference }} Month</td>
                </tr>
                <tr>
  ...
  <main>
    <h1 class="text-center">There are currently no Work Orders in this System.</h1>
  </main>
  <footer style="position: absolute; bottom:0; width:100%">
    <table>
      <tbody >
