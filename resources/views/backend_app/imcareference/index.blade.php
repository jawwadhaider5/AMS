...
@endsection
    ...
    <div class="container-xxl flex-grow-1 container-p-y"> 
      ...
      @can('create imca reference')
      <div class="row">
        <div class="col-12">
          <a href="{{route('add-imca')}}" class="btn btn-primary w-auto float-end mb-2 mx-3">IMCA Reference +</a>
        </div>
      </div>
      @endcan
      <div class="card">
        ...
        <div class="table-responsive text-nowrap">
          <table class="table" id="imca_table">
            <thead>
            ...
            <tbody id="table-body">
              ...
              <tr>
                ...
                <td>
                  @can('edit imca reference')
                  <a href="{{ route('edit-imca', $imca->id) }}" class="btn btn-sm btn-outline-primary" title="Edit">
                    <i class="fas fa-edit"></i>
                  </a>
                  @endcan
                  @can('delete imca reference')
                  <a href="{{ route('delete-imca', $imca->id) }}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this?')" title="Delete">
