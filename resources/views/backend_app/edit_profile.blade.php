      ...
      <div class="col-md-12">
        <ul class="nav nav-pills flex-column flex-md-row mb-4">
          <li class="nav-item" id="account" style="cursor: pointer;">
            <a class="nav-link active" id="account_inner"><i class="ti-xs ti ti-users me-1"></i> Account</a>
          </li>
          <li class="nav-item" id="security" style="cursor: pointer;">
            <a class="nav-link" id="security_inner"><i class="ti-xs ti ti-lock me-1"></i> Security</a>
          </li>
